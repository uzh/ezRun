library(ezRun)
source("~/workspaceR/dayme-scripts/sushi_scripts_mod/app-SCMultipleSamplesAndGroups.R")  #remove later
...
param[['resultDir']] = 'p2979/SCReportMerging_33387_2019-06-28--15-08-08'
output = list()
...
output[['Static Report [Link]']] = 'p2979/SCReportMerging_33387_2019-06-28--15-08-08/SCReportMerging/00index.html'
output[['Report [File]']] = 'p2979/SCReportMerging_33387_2019-06-28--15-08-08/SCReportMerging'
input = '/srv/gstore/projects/p2979/SCReportMerging_33387_2019-06-28--15-08-08/input_dataset.tsv'
EzAppSCMultipleSamplesAndGroups$new()$run(input=input, output=output, param=param)
...
debug(ezMethodSCMultipleSamplesAndGroups)
ezMethodSCMultipleSamplesAndGroups(input=input, output=output, param=param)
