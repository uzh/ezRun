...
ezMethodMetaspades = function(
  ...
  ##update template
  updateTemplateScriptCmd <- paste0(
    "sed -e s/\"SAMPLE_NAME\"/",
    sampleName,
    "/g",
    " -e s/\"INPUT_FILE_STRING_BWT\"/",
    inputStringBwt2,
    "/g ",
    " -e s/\"INPUT_FILE_STRING_ASS\"/",
    inputStringAss,
    "/g ",
    " -e s/\"KMER_LIST\"/",
    param$metaspadesKmerList,
    "/g ",
    " -e s/\"NUM_CPU\"/",
    param$cores,
    "/g ",
