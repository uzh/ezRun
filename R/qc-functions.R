...
getRefBuildMap = function(){
  refBuildMap = c(
    ...
    "Fusarium oxysporum"="/srv/GT/reference/Fusarium_oxysporum/Misc/Fo5176/Annotation/Release_5176-2019-03-18",
    "Canis lupus familiaris"="/srv/GT/reference/Canis_familiaris/Ensembl/CanFam3.1/Annotation/Release_89-2017-06-07",
    "Cricetulus griseus (Chinese hamster)"="/srv/GT/reference/Cricetulus_griseus/CHO/CHO-K1/Annotation/Version-2015-12-11/Genes",
    "Felis silvestris catus"="/srv/GT/reference/Felis_catus/Ensembl/Felis_catus_6.2/Annotation/Release_89-2017-06-07",
    "Candida glabrata"="/srv/GT/reference/Candida_albicans/CGD/SC5314_Assembly22/Annotation/Release_2018-11-13",
    "Toxoplasma gondii"="/srv/GT/reference/Toxoplasma_gondiiME49/ToxoDB/TgondiiME49_R33/Annotation/Release_33-2017-07-28",
    "Sus Linnaeus (Pig)"="/srv/GT/reference/Sus_scrofa/Ensembl/Sscrofa11.1/Annotation/Release_90-2017-11-17",
    "Canis familiaris"="/srv/GT/reference/Canis_familiaris/Ensembl/CanFam3.1/Annotation/Release_89-2017-06-07",
    "Sus scrofa"="/srv/GT/reference/Sus_scrofa/Ensembl/Sscrofa11.1/Annotation/Release_90-2017-11-17",
    "Bos taurus"="/srv/GT/reference/Bos_taurus/Ensembl/UMD_v3.1/Annotation/Release_92-2018-05-30",
    "Rattus norvegicus"="/srv/GT/reference/Rattus_norvegicus/Ensembl/Rnor_6.0_properlyGenerated/Annotation/Release_Rnor_6.0_properlyGenerated-2018-11-05",
    "Gallus gallus (chicken)"="/srv/GT/reference/Gallus_gallus/Ensembl/Gallus_gallus-5.0/Annotation/Release_89-2017-06-08",
    "Danio rerio (zebrafish)"="/srv/GT/reference/Danio_rerio/Ensembl/GRCz11/Annotation/Release_96-2019-04-22",
    "Drosophila melanogaster (fruit fly)"="/srv/GT/reference/Drosophila_melanogaster/Ensembl/BDGP6/Annotation/Release_89-2017-06-07",
    "Caenorhabditis elegans (nematode)"="/srv/GT/reference/Caenorhabditis_elegans/Ensembl/WBcel235/Annotation/Release_90-2017-08-31",
    "Saccharomyces cerevisiae (bakers yeast)"="/srv/GT/reference/Saccharomyces_cerevisiae/Ensembl/R64/Annotation/Version-2015-08-04",
    "Oryza sativa (rice)"="/srv/GT/reference/Oryza_sativa_japonica/Ensembl/IRGSP_1.0/Annotation/Release_42-2019-01-28",
    "Arabidopsis thaliana (thale cress)"="/srv/GT/reference/Arabidopsis_thaliana/Araport/Araport11/Annotation/Release_02-2017-10-22",
    "Zea mays"="/srv/GT/reference/Sus_scrofa/Ensembl/Sscrofa11.1/Annotation/Release_90-2017-11-17",
    "Triticum aestivum"="/srv/GT/reference/Triticum_aestivum/URGI/IWGSCv3/Annotation/Version-2016-05-09",
    "Escherichia coli"="/srv/GT/reference/Escherichia_coli/Ensembl/K12_MG1655_ASM584v2/Annotation/Release_2019-01-31"
  )
  return(refBuildMap)
}
