...
getRefBuildMap = function(){
  refBuildMap = c(
    ...
    "Rattus norvegicus"="Rattus_norvegicus/Ensembl/Rnor_6.0_properlyGenerated/Annotation/Release_Rnor_6.0_properlyGenerated-2018-11-05",
    ...
    "Arabidopsis thaliana (thale cress)"="Arabidopsis_thaliana/Araport/Araport11/Annotation/Release_02-2017-10-22",
