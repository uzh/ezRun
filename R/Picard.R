...
CollectAlignmentSummaryMetrics <- function(
  inBams,
  fastaFn,
  paired = FALSE,
...
CollectRnaSeqMetrics <- function(
  ...
  outputFns <- tempfile(pattern = inBams, fileext = ".CollectRnaSeqMetrics")
  cmd <- paste(
    prepareJavaTools("picard"),
    "CollectRnaSeqMetrics",
    paste0("I=", inBams),
