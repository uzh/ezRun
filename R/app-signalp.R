...
ezMethodSignalP = function(input=NA, output=NA, param=NA, htmlFile="00index.html"){
  ...
  cmd = paste("signalp -fasta", proteins, "-format", oformat, "-gff3 -org", org, "-plot", pformat, "-prefix", sampleName, opt, "1>", paste0(sampleName,"_signalp.log"))
  ezSystem(cmd)
  return("Success")
}
