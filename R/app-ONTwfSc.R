...
ezMethodONTwfSc <- function(input = NA, output = NA, param = NA) {
  ...
  cmd = paste(
    "nextflow run /srv/GT/software/epi2me-labs/wf-single-cell/",
    "-w",
    paste0(samplename, "/workspace"),
    "--fastq",
    sampledataset,
    "--kit_name",
    kitname,
    ...
    expCells,
    "--ref_genome_dir",
    paste0("/srv/GT/reference/ont-wf-single-cell/", refbuild),
    "--out_dir",
    samplename,
    "-profile singularity",
    "--plot_umaps"
