...
### MetaCore 
```{r metacore annotate, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r metacore prepare, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r metacore export, echo=FALSE, message=FALSE, eval=FALSE}
