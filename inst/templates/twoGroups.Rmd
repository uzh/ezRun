...
if (sum(use) > param$minGenesForClustering){
  ...
  write_xlsx(resultLoaded, file=resultFile$resultFile)
...
write_tsv(resultMetaCore, file=metacoreFile)
```
...
#### How To Use MetaCore 
[Click to Download Expression File for Import into MetaCore](`r metacoreFile`)
