...
* A gene identifier, pick **one** of:
  + For human, mouse, or rat, use Ensembl Gene IDs -- `ENSEMBL IDs` 
  + For any other species, use Entrez Gene IDs -- `EntrezGene (LocusLink) IDs`
  
* Log fold changes of the genes -- `log ratio` 

* *P* value. This is the raw p-value, so you may want to apply a threshold. 
