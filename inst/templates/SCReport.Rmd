...
# tSNE_data <- tibble(X=scData@dr$tsne@cell.embeddings[colnames(cd),"tSNE_1"],
#                     Y=scData@dr$tsne@cell.embeddings[colnames(cd),"tSNE_2"],
...
param[c("minGenesPerCell", "maxGenesPerCell", "minReadsPerCell", "pcs",
