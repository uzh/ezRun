...
for (rankNames  in taxRanks){
  ...
  if (tempAbundPlotFilt$stop==TRUE) {
    ...
    plotTitle <- paste("Community composition in each sample at the rank", rankNames, "for the filtered dataset.\n Only taxa observed at least",rawCount, " times in at least", percentFrac,"% of the samples are kept.")
...
plotTitle <- paste("Community composition at the rank", rankNames, "for the unfiltered dataset.")
...
for (rankNames  in taxRanks){
  ...
  plotTitle <- paste("Community composition in each group at the rank", rankNames, "for the filtered dataset.\n  Only taxa observed at least",rawCount, " times in at least", percentFrac,"% of the samples are kept.")
