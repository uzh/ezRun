...
if (isGroupThere) {
  abundPlotGroup <- plot_bar(physeqFullObject, "Genus", fill="Genus", facet_grid=~group) + geom_bar(aes(fill=Genus), stat="identity", position="stack")  +theme(axis.text.x = element_blank())
}
```
