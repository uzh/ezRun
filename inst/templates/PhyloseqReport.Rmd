...
if (isGroupThere) {
  ...
  #abundPlotGroup <- plot_bar(physeqFullObject, x="Group", fill="Phylum") + #geom_bar(aes(color=Phylum, fill=Phylum), stat="identity", position="stack")
}
```
...
```{r abund, echo=FALSE,out.width="100%",eval=isGroupThere}
plot(abundPlotGroup)
```
...
#### Summary table (top 50 differentially expressed organisms)
