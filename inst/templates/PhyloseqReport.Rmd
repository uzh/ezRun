...
### rarefaction: 3. richness. Here we use only the unfiltered dataset.
plotTitle <- paste("Rarefaction plots based on the selection of the most abundant", N, "ranks")
```
...
for (rankNames  in taxRanks){
rarefPlot(physeqFullObject,rankNames,N)
}
...
```{r deSeqTableZip, echo=FALSE,eval=isGroupThere}
### save table
  write.table(deseqResults$fullTable,diffAbundTableName,
