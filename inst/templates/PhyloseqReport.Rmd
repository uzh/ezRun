...
showHeatmap <- plot_heatmap(physeqFullObject@otu_table@.Data, taxa.label="Phylum")

### create plots:5. pheatmap
## add colours 
show_pHeatmap <- plot_heatmapPheatmap(physeqFullObject@otu_table@.Data)
```
...
```{r heat, echo=FALSE,out.width="100%",eval=isGroupThere}
  ...
  #plot(plotHeatmap)
  #show_heatmap <- expression({heatmapForPhylotseqPlot(physeqFullObject@otu_table@.Data)})
  #eval(show_heatmap)
showHeatmap()
show_pHeatmap()
# pheatmap
