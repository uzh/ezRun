...
for (rankNames  in taxRanks){
  ...
  if (tempAbundPlotFilt$stop==TRUE) {
    ...
    plotTitle <- paste("Community composition in each sample at the rank", rank, "for the filtered dataset.\n Only taxa observed at least",rawCount, " times in at least", percentFrac,"% of the samples are kept.")
...
for (rankNames  in taxRanks){
  ...
  plotTitle <- paste("Community composition in each group at the rank", rank, "for the filtered dataset.\n Only taxa observed at least",rawCount, " times in at least", percentFrac,"% of the samples are kept.")
