...
if (isGroupThere) {
for (rankNames  in taxRanks){
  tempAbundPlotUnfilt <-  abundPlot(rankNames,physeqObjectNoTreeUnfilt,xAes="Group",y="relGroupFract")
  tempAbundPlotFilt <- abundPlot(rankNames,physeqFullObject,xAes="Group",y="relGroupFract")
