...
<!-- PATTERN 4 — three levels of nesting (tabset → tabset → tabset). The
     tab-numbering script in fgcz-plot-finder.html labels these automatically:
     this top tab is e.g. "4", its sub-tabs "4.1"/"4.2", and their sub-tabs
     "4.1.1"/"4.1.2" … — no manual numbering in the .qmd.
...
<!-- PATTERN 5 — five levels of nesting (tabset → … → tabset), to preview the
     full tab palette: each depth has its own colour (L1 deep blue · L2 cyan ·
     L3 sky · L4 teal · L5 indigo; see fgcz.scss). This top tab is level 1; each
     nested ::: {.panel-tabset} steps one level deeper. The numbering script in
     fgcz-plot-finder.html labels them automatically (5 · 5.1 · 5.1.1 · …).
