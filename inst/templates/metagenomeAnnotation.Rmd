...
summaryFamilyPlot <- summaryFamilyPlot + guides(fill=guide_legend(ncol=3, byrow=F,title.position = "top"))
...
summaryGOPlot <- summaryGOPlot +  guides(fill=guide_legend(ncol=3, byrow=F,title.position = "top"))
```
