...
summaryFamilyPlot <- summaryFamilyPlot + geom_bar(stat = "Identity")+theme(axis.text.x = element_blank(), axis.title.x = element_blank(), legend.position = "bottom",legend.text = element_text(size =6)) + scale_color_manual(expandedPalette)
...
summaryGOPlot <- summaryGOPlot + geom_bar(stat = "Identity")+theme(axis.text.x = element_blank(), axis.title.x = element_blank(),legend.position = "bottom",legend.text = element_text(size =6)) + scale_color_manual(expandedPalette)
