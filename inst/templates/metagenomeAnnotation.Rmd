...
summaryRBSSpacePlotList <- lapply(prodigalList, function(x)summaryRBSSpacePlo(x$subsetDataToPartial00))
  
summaryRBSMotifPlotList <- lapply(prodigalList, function(x)summaryRBSMotif(x$subsetDataToPartial00))
