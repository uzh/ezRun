...
### Prodigal gene prediction: confidence and GC_content
...
plot(summaryGcContPlotList[["megahit"]])
```
...
### Prodigal gene prediction: RBS spacer
...
### Prodigal gene prediction: RBS motif
...
```{r summaryFuncPlot, echo=FALSE,out.width="70%"}
plot(summaryGOPlot)
