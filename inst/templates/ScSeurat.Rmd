...
The iSEE shiny app can be accessed through this link [iSEE explorer](`r {paste0("https://fgcz-shiny.uzh.ch/fgcz_iSEE", sample(0:9, size=1), "/?data=",output$getColumn("SC Cluster Report"),"/sce_h5")}`){target="_blank"}
