...
```{r, fig.width=12, fig.height=shrinkToRange(length(param$controlSeqs)*3/4, 6, 18), eval=ezIsSpecified(param$controlSeqs)}
...
```{r plot of user genes, fig.width=12, fig.height=shrinkToRange(length(param$controlSeqs)/5, 6, 12)}
