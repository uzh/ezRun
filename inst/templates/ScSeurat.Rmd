...
[single cell explorer](`r {paste0("https://fgcz-shiny.uzh.ch/exploreSC", "/?data=",output$getColumn("SC Cluster Report"), "/scData.qs")}`){target="_blank"}
...
[scData.qs](scData.qs) -- final seurat object
