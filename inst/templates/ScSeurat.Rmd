...
```{r cell cycle, fig.width=6, fig.height=6, eval=!is.null(scData@meta.data$CellCycle)}
...
```{r decontx, fig.width=6, fig.height=6, eval=!is.null(scData@meta.data$DecontX_contFrac)}
...
```{r soupx, fig.width=6, fig.height=6, eval=!is.null(scData@meta.data$SoupX_contFrac)}
...
```{r cell probability, fig.width=6, fig.height=6, eval=!is.null(scData@meta.data$negLog10CellPValue)}
