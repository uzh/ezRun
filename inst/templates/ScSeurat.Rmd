...
# Generate ~100 colors by combining multiple palettes from pals package
shared_colors <- c(
  DiscretePalette(n = 26, palette = "alphabet"),      # 26 colors
  DiscretePalette(n = 26, palette = "alphabet2"),     # 26 colors
  DiscretePalette(n = 36, palette = "polychrome"),    # 36 colors
  DiscretePalette(n = 26, palette = "alphabet"),      # 26 colors (repeat)
