...
qcStats[ "Total removed (auto)", ]<- c(sum(!allCellsMeta$useCell), NA, NA)
qcStats[ "Total removed (manual)", ]<- c(sum(allCellsMeta$useCell) - ncol(scData), NA, NA)
qcStats[ "Cells remaining", ]<- c(ncol(scData), NA, NA)
