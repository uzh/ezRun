...
[single cell explorer](`r {paste0("https://fgcz-shiny.uzh.ch/exploreSC", "/?data=",output$getColumn("Report"), "/scData.qs")}`){target="_blank"}
...
##### The final Seurat object is [here](scData.qs)
