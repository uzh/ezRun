...
if(numSigRegions < 1){
    cat('No significant regions detected. Instead top 100 regions reported \n')
    numSigRegions <- regions[1:n, ]
}
...
if(numSigBlocks < 1){
    cat('No significant block detected. Instead top 100 blocks reported \n')
    sigBlocks <- blocks[1:n, ]
}
