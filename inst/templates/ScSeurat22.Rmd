...
plotColData(xxAll, x="Sample", y="nFeature_RNA", colour_by="discard") + scale_y_log10() + ggtitle("Detected genes")
...
plotColData(xxAll, x="nCount_RNA", y="percent_mito", colour_by="discard")

#FeatureScatter(scData.unfiltered, feature1="nCount_RNA", feature2="percent_mito", group.by="discard", ) + scale_x_log10() + ggtitle("", subtitle = "higlighting discarded droplets")
```
...
VlnPlot(scData, features=c("nCount_RNA", "nFeature_RNA", "percent_mito", "percent_riboprot"), group.by="Sample", ncol = 4)
```
...
```{r, fig.width=6, fig.height=6, eval=!is.null(scData@meta.data$CellCycle)}
  DimPlot(scData, label=TRUE, group.by= "CellCycle")
```
