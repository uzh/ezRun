...
### stepsData
convStepTableToReport <- imap(listOfListAllFiles["stepConvergence"]$stepConvergence, function(x,y) createStepConvTableForKableExtra(x))
...
otuSaturationTableToReport <- imap(listOfListAllFiles["OTUsCountTable"]$OTUsCountTable, function(x,y) createSaturationTableForKableExtra(x)) 
