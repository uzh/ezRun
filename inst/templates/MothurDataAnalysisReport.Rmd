...
otuSaturPlotToReport <- imap(listOfListAllFiles["OTUsCountTable"],function(x,y) otuSaturationPlot(x))
...
### Chimera plot
chimeraPlotsToReport <- imap(listOfListAllFiles["ChimeraPlot"],function(x,y) chimeraSummaryPlot(x))
```
