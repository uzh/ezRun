...
otuSaturPlotToReport <- sapply(listOfListAllFiles["OTUsCountTable"]$OTUsCountTable,createSaturationPlotsForReport(x))
...
plot_grid(plotlist = chimeraPlotsToReport,labels = plotLabels, nrow = 2)
```
