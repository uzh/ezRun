...
otuSaturPlotToReport <- imap(listOfListAllFiles["OTUsCountTable"][[1]],function(x,y) createSaturationPlotsForReport(x))
...
kable(convStepTableToReport$mergedTable, escape=TRUE, row.names=FALSE, format="html",
  ...
  kable_styling(bootstrap_options = c("striped", "bordered"),
                full_width = F, position = "left") %>%
  add_header_above(finalListOfSummaryTables[[convStepTableToReport$aboveHeader]])
```
