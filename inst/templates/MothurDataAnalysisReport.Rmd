...
### Chimera plot
chimeraPlotsToReport <- createChimeraSummaryPlotsForReport(listOfListAllFiles["ChimeraPlot"]$ChimeraPlot)
```
...
```{r,echo=FALSE, out.width='.49\\linewidth', fig.show='hold',fig.align='center'}
#for (chimPlot in chimeraPlotsToReport){
  plot(chimeraPlotsToReport)
#}
#grid.arrange(grobs=chimeraPlotsToReport,ncol=1, 
#             widths=unit(c(10), c("in")))
```
...
grid.arrange(grobs=otuSaturPlotToReport,ncol=2)
```