...
assaySCnames<- names(scData@assays) 
visiumHDassays <- c("Spatial", "Spatial.016um", "Spatial.008um")
assaySC <- intersect(visiumHDassays, assaySCnames)[1]
...
```{r banksy plot spatial, fig.width=6, fig.height=6}
...
p_niches <- SpatialDimPlot(scData,
