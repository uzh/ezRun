...
plot1 <- VlnPlot(scData, features=nCountCol, group.by="seurat_clusters") + ggtitle("Number of UMIs vs cluster") + 
  NoLegend()
plot2 <- VlnPlot(scData, features = nFeatureCol, group.by="seurat_clusters", pt.size = 0.1) + 
