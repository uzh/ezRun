...
plotColData(xxAll, x="Sample", y=nCountCol, colour_by="discard") + scale_y_log10() + ggtitle("Number of UMIs")
```

```{r QC plots2, fig.height=6}

plotColData(xxAll, x="Sample", y=nFeatureCol, colour_by="discard") + ggtitle("Detected genes")
plotColData(xxAll, x=nCountCol, y=nFeatureCol, colour_by="discard")+ scale_x_log10() + scale_y_log10()
...
plotColData(xxAll, x=nCountCol, y="genePerCount", colour_by="discard")+ scale_x_log10() + xlim(1, 10000) + ylim(0.2, 0.8)

plotColData(xxAll, x="Sample", y="percent_mito", colour_by="discard") + ggtitle("Mito percent")
plotColData(xxAll, x= nCountCol, y="percent_mito", colour_by="discard")+ scale_x_log10()
...
if (!is.null(xxAll$percent_riboprot)){
  ...
  print(plotColData(xxAll, x=nCountCol, y="percent_riboprot", colour_by="discard")+ scale_x_log10())
}
```
...
#}
plot5 <- SpatialFeaturePlot(scData, features = nCountCol, pt.size.factor =  2) + theme(legend.position = "right")
plot6 <- SpatialFeaturePlot(scData, features = nFeatureCol, pt.size.factor =  2) + theme(legend.position = "right")
