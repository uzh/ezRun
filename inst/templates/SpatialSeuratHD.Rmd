...
plot1 <- VlnPlot(scData, features="nCount_Spatial.016um", group.by="seurat_clusters", pt.size = 000-0) + ggtitle("Number of UMIs vs cluster") + 
  NoLegend()
plot2 <- VlnPlot(scData, features = "nFeature_Spatial.016um", group.by="seurat_clusters", pt.size = 0) + 
  ggtitle("Number of genes vs cluster") +
  NoLegend()
plot3 <- VlnPlot(scData, features = "percent_mito",  group.by ="seurat_clusters", pt.size = 0) + 
