...
```{r composition analysis, results='asis', fig.width=11, fig.height=11, message=FALSE, warning=FALSE}
...
sccomp_res |> sccomp_boxplot(factor = "Condition") + theme(
    strip.text = element_text(size = 16, face = "bold"),  # Adjust cell type title size
...
# Interval
sccomp_result |> 
  plot_1D_intervals() + theme(axis.text.y = element_text(size = 12)) 
```
