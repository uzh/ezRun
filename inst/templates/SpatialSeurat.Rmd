...
<div class = "col-md-6">
```{r low quality spots}
SpatialFeaturePlot(scData.unfiltered_spatial, features = 'discard', pt.size.factor = param$pt.size.factor) + ggplot2::scale_fill_continuous(limits = c(0,1), breaks = c(0.0, 1.0)) + theme(legend.position = "right") + theme(aspect.ratio = myRatio) + labs(fill = "Discarded")
