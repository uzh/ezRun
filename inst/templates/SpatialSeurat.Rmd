...
plot1 <- SpatialFeaturePlot(scDataRaw, features = "nCount_Spatial", pt.size.factor = 2 * param$imageEnlargementFactor, min.cutoff = 'q1', max.cutoff = 'q50') + theme(legend.position = "right") 
plot2 <- SpatialFeaturePlot(scDataRaw, features = "nFeature_Spatial", pt.size.factor = 2 * param$imageEnlargementFactor, min.cutoff = 'q1', max.cutoff = 'q50') + theme(legend.position = "right")
