...
#Load result files:
bismarkBSseq_filtered <- ezLoadRobj("bismarkBSseq_filtered")
regions <- ezLoadRobj("dmrseq_results")
blocks <- ezLoadRobj("large_blocks")
dssResults <- ezLoadRobj("dss_results")
```
