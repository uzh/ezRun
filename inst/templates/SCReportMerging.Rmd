...
sce1 <- readRDS(file.path(param$dataRoot,
                          sub("https://fgcz-gstore.uzh.ch/projects", "", dirname(sce1URL), 
                              fixed=TRUE), "sce.rds"))
sce2 <- readRDS(file.path(param$dataRoot,
                          sub("https://fgcz-gstore.uzh.ch/projects", "", dirname(sce2URL), 
                              fixed=TRUE), "sce.rds"))
...
The final Seurat object after merging is [here](`r scDataFn`).
