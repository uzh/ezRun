...
# sceURLs <- c("https://fgcz-sushi.uzh.ch/projects/p2326/SCReport_31783_sample1_3days_v-run_2018-12-03--16-22-12/SCReport/00index.html",
#              "https://fgcz-sushi.uzh.ch/projects/p2326/SCReport_31783_sample2_2wks_v_run_2018-12-03--15-14-48/SCReport/00index.html",
#              "https://fgcz-sushi.uzh.ch/projects/p2326/SCReport_31783_2018-12-17--16-21-45/sample3_sedentary_SCReport/00index.html")
...
# TODO: sub clusters for more samples
if(ezIsSpecified(param$chosenClusters1)){
  chosenCells1 <- names(metadata(sceList[[1]])$scData@ident)[metadata(sceList[[1]])$scData@ident %in% 
                                                               param$chosenClusters1]
  sceList[[1]] <- sceList[[1]][, chosenCells1]
  metadata(sceList[[1]])$scData <- SubsetData(metadata(sceList[[1]])$scData,
                                      ident.use=param$chosenClusters1)
}
if(ezIsSpecified(param$chosenClusters2)){
  chosenCells2 <- names(metadata(sceList[[2]])$scData@ident)[metadata(sceList[[2]])$scData@ident %in% 
                                                               param$chosenClusters2]
  sceList[[2]] <- sceList[[2]][, chosenCells2]
  metadata(sceList[[2]])$scData <- SubsetData(metadata(sceList[[2]])$scData,
                                              ident.use=param$chosenClusters2)
}
if(ezIsSpecified(param$chosenClusters3)){
  chosenCells3 <- names(metadata(sceList[[3]])$scData@ident)[metadata(sceList[[3]])$scData@ident %in% 
                                                               param$chosenClusters3]
  sceList[[3]] <- sceList[[3]][, chosenCells3]
  metadata(sceList[[3]])$scData <- SubsetData(metadata(sceList[[3]])$scData,
                                              ident.use=param$chosenClusters3)
}
```
...
```{r diff marker files, echo=FALSE, results="asis"}
