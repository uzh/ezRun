...
if(ezIsSpecified(param$chosenClusters)){
  for(eachCluster in names(param$chosenClusters)){
    chosenCells <- names(metadata(sceList[[eachCluster]])$scData@ident)[metadata(sceList[[eachCluster]])$scData@ident %in% param$chosenClusters[[eachCluster]]]
    sceList[[eachCluster]] <- sceList[[eachCluster]][, chosenCells]
    metadata(sceList[[eachCluster]])$scData <-
      SubsetData(metadata(sceList[[eachCluster]])$scData,
...
param[c("batchCorrection", "cc", "resolution", "chosenClusters")]
```
