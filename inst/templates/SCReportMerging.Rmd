...
```{r conserved markers SplitDotPlotGG, echo=FALSE}
...
```{r visulisatio conserved markers, echo=FALSE, fig.width=8, fig.height=length(unique(scData@ident)) * length(unique(scData@meta.data$Plate))*0.4}
