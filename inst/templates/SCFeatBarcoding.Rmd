...
```{r singler ScoreHeatmap,  eval= (species != "other"), fig.height=var_heigth, fig.width=8, results='asis'}
...
```{r singler labelsUMAP,  eval= (species != "other"), fig.width=12, results='asis'}
...
```{r assigments heatmap, eval= (species != "other"), results='asis',fig.align='center', fig.width=10, fig.height=var_heigth}
