...
```{r singler ScoreHeatmap,  eval= (param$species != "other"), fig.height=length(unique(singler.single.labels))*0.7, fig.width=8, results='asis'}
...
```{r assigments heatmap, eval= (param$species != "other"), results='asis',fig.align='center', fig.width=10, fig.height=nrow(tab)*0.5}
