...
var_heigth = length(unique(singler.single.labels))*0.3
```


```{r singler ScoreHeatmap,  eval= (param$species != "other"), fig.height=var_heigth, fig.width=8, results='asis'}
...
```{r assigments heatmap, eval= (param$species != "other"), results='asis',fig.align='center', fig.width=10, fig.height=var_heigth}
