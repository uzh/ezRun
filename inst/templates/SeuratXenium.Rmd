...
# Count cell types for legend handling
n_celltypes <- length(unique(na.omit(scData@meta.data[[celltype_col]])))

# Spatial plot first - use Seurat default colors
...
p2 <- DimPlot(scData, group.by = celltype_col,
