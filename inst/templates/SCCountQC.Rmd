...
## debug
# title:  "`r metadata(sce)$param$name`"
# sce <- readRDS("/srv/gstore/projects/p2488/SCCountQC_41384_2019-11-17--14-42-12/iCount_mESC_plate_2_20191028BJ_SCCountQC/sce.rds")
...
## scater sce
cell_info <- data.frame(row.names=colnames(cts),
                        lib_size=Matrix::colSums(cts)/1e3,
                        expr_genes = Matrix::colSums(cts >= param$minReadsPerGene),
                        perc_mito=Matrix::colSums(cts[isMito, , drop=FALSE])*100 / Matrix::colSums(cts))
