...
# sce <- readRDS("/srv/gstore/projects/p2838/SCCountQC_32064_2019-01-09--11-48-55/NCC_Trpv5_Tomato_sc_A01_SCCountQC/sce.rds")
## convention:
...
param$minReadsPerGene <- switch(param$scProtocol,
                                "smart-Seq2"=3,
                                "10X"=1)
...
result = tryCatch({
    ...
    cat(paste0("The plot couldn't be calculated beacuse of the following warning: ", warning, " Please, contact a bioinformatician."))
}, error = function(error) {
    cat(paste0("The plot couldn't be calculated beacuse of the following error: ", error, " Please, contact a bioinformatician."))
})
...
<!-- ```{r VlnPlot, echo=FALSE, fig.width=10, fig.height=ifelse(nchar(scData@project.name) > 20, 10, 7), eval=!debug && FALSE} -->
<!-- VlnPlot(object=scData, features.plot = c("nGene", "nUMI", "perc_mito"), -->
<!--         nCol=3,  -->
<!--         x.lab.rot=ifelse(nchar(scData@project.name) > 20, TRUE, FALSE)) -->
<!-- ``` -->

<!-- ```{r seurat filter and normalize, echo=FALSE, eval=!debug && FALSE} -->
...
<!-- ```{r seurat variable gene, echo=FALSE, eval=doSeurat && !debug && FALSE} -->
<!-- scData <- FindVariableGenes(object=scData) -->
<!-- ``` -->

<!-- The number of variable genes: `r length(x = scData@var.genes)`. -->

<!-- ```{r scale and PCA calculation, echo=FALSE, message=FALSE, results='hide', eval=doSeurat && !debug && FALSE} -->
...
<!-- ```{r plot viz PCA, echo=FALSE, fig.width=10, fig.height=15, eval=doSeurat && !debug && FALSE} -->
<!-- VizPCA(object = scData, pcs.use = 1:6) -->
<!-- ``` -->

<!-- ```{r plot PCA, echo=FALSE, fig.width=7, fig.height=7, eval=doSeurat && !debug && FALSE} -->
<!-- PCAPlot(object = scData, dim.1 = 1, dim.2 = 2) -->
<!-- ``` -->

<!-- ```{r PCHeatmap, echo=FALSE, fig.width=10, fig.height=30, eval=doSeurat && !debug && FALSE} -->
...
<!-- ```{r JackStraw, echo=FALSE, fig.width=10, fig.height=25, eval=doSeurat&& !debug && FALSE} -->
...
<!-- ```{r PCElbowPlot, echo=FALSE, eval=doSeurat && !debug && FALSE} -->
