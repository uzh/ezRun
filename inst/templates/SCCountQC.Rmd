...
# if(param$scProtocol == "smart-Seq2"){
#   colnames(rawCount) <- colnames(assays(sce)$counts)
# }else if(param$scProtocol == "10x"){
...
# if(param$scProtocol != "10x"){
  ...
  # if(param$scProtocol == "smart-Seq2"){
  #   colnames(tpm) <- colData(sce)$Name
  # }else if(param$scProtocol == "10x"){
  #   colnames(tpm) <- colData(sce)$Barcode
  # }
...
# if(param$scProtocol == "smart-Seq2"){
#   colnames(cpm) <- colData(sce)$Name
# }else if(param$scProtocol == "10x"){
#   colnames(cpm) <- colData(sce)$Barcode
# }
