...
* Number of cells (with less than `r param$minReadsPerCell` reads aligned) removed:  `r ncol(sce)-ncol(sceScater)`
...
```{r plot PCA, echo=FALSE, fig.width=10, fig.height=15, eval=doSeurat && !debug}
