...
#### The 20 most specific markers (highest difference in the expression in one cluster compared to the rest) are represented on the Ridge and the TSNE plots.
<br/>

```{r top cluster markers, fig.width=4, fig.height=3, results = 'asis'}
n_markers <- 20
for(i in 1:n_markers){
    print(RidgePlot.sce(sce, feature = as.character(posMarkers$gene[i])))
    print(plotReducedDim(sce, dimred="TSNE", colour_by=posMarkers$gene[i]))
  }
```
### Cells annotation
