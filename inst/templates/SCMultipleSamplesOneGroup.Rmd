...
Here, we use a heatmpa and a dotplot to visualize simultaneously the top 5 markers in each cluster. Be aware that some genes may be in the top markers for different clusters.
...
geneMeans <- rowsum(t(tr_cnts), group=sce$seurat_clusters)
