...
rawScreenResult <- ezLoadRobj("rawScreenResult")
procScreenResult <- ezLoadRobj("procScreenResult")
virusResult <- ezLoadRobj("virusResult")

if (ezRobjExists("refseqResult")) {
  refseqResult <- ezLoadRobj("refseqResult")
} else {
  refseqResult <- NULL
}

krakenResult <- ezLoadRobj("krakenResult")
rRNAstrandResult <- ezLoadRobj("rRNAstrandResult")
PWMresult <- ezLoadRobj("PWMs")
dataset <- input$meta
