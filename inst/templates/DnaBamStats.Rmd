...
# would get too narrow side by side. Taller plots in the side-by-side layout.
...
if (mmTwoCol) {
  mmTotal <- mmTotal %>% plotly::layout(height = 640)
  mmRelative <- mmRelative %>% plotly::layout(height = 640)
}
htmltools::div(
  style = paste0(
