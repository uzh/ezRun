...
make_metric_plot <- function(
  ...
  plotObj <- plot_ly(
    ...
    layout(
      ...
      margin = list(l = if (showLabels) 130 else 40, r = 20, t = 60, b = 50)
    )
...
Descriptive in v1 (no QC flags). Percent of reference at ≥1x / ≥20x is in the Full Sample Summary.

```{r coverage breadth plots, echo=FALSE}
subplot(
  make_metric_plot(
  ...
  make_metric_plot(
    metricName = "CoverageCV",
    title = "Coverage evenness (CV = SD / mean)",
    unit = "",
    showLabels = FALSE,
    thresholded = FALSE
  ),
