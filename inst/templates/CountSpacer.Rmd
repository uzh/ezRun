...
```{r plots, fig.width=4, fig.height=6, echo=FALSE, message=FALSE, warning=FALSE, eval=!debug}
...
```{r plots, fig.width=5, fig.height=6, echo=FALSE, message=FALSE, warning=FALSE, eval=!debug}
...
```{r plots, fig.width=5, fig.height=5, echo=FALSE, message=FALSE, warning=FALSE, eval=!debug}
