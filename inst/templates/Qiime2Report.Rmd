...
nextflow run epi2me-labs/wf-artic --fastq data/  --sample_sheet data/sample_sheet.csv --out_dir analysis --scheme_version V4.1 -profile#### Bar plot 
...
nextflow run epi2me-labs/wf-artic --fastq data/  --sample_sheet data/sample_sheet.csv --out_dir analysis --scheme_version V4.1 -profile
