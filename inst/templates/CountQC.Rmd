...
#### Sample clustering
```{r sample clustering, echo=FALSE, fig.height=7, fig.width=min(7 + (nSamples-10)*0.3, 30)}
if (nSamples > 3){
  ## All genes
...
#### Sample clustering
```{r gene wise sample clustering, echo=FALSE, fig.height=7, fig.width=min(7 + (nSamples-10)*0.3, 30)}
if (nSamples > 3){
  ## All genes
