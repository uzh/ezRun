...
```{r cluster Silhouette, echo=FALSE, results="asis", eval=!debug}
if(length(varFeatures) > param$minGenesForClustering){
calculate_silhouette_hc <- function(data, hc, k) {
...
k_values <- 2:10
sil_scores <- sapply(k_values, calculate_silhouette_hc, data = assays(rawData)$log2signalCentered[varFeatures, ], hc = hc)
