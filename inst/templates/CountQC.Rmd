...
```{r MDS plot 3D present, echo=FALSE, message=FALSE, fig.height=7, eval=TRUE}
if(nSamples > 3){
...
```
```{r MDS plot 2D present, echo=FALSE, message=FALSE, fig.height=7, eval=TRUE}
if(nSamples > 3){
...
```{r MDS plot 3D top, echo=FALSE, message=FALSE, fig.height=7, eval=TRUE}
if(nSamples > 3){
...
```{r MDS plot 2D top, echo=FALSE, message=FALSE, fig.height=7, eval=TRUE}
if(nSamples > 3){
