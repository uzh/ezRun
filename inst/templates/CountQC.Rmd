...
```{r scatter plot narrow, echo=FALSE, message=FALSE, results='asis', fig.width=min(envir$nPlots, 6) * 3 * 1.65, fig.height=ceiling(envir$nPlots/6) * 3.3 * 1.65, out.width="1500px", eval=ncol(rawData) > 3 & param$writeScatterPlots}
