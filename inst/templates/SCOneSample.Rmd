...
```{r singler ScoreHeatmap,  eval= (species != "other"), fig.height=length(unique(singler.single.labels))*0.3, fig.width=8, results='asis'}
...
```{r assigments heatmap, eval= (species != "other"), results='asis',fig.align='center', fig.width=10, fig.height=nrow(tab)*0.5}
