...
library(Seurat)
library(AUCell)
sce <- readRDS("/srv/gstore/projects/p3155/SCOneSample_42026_2020-01-23--14-43-22/Sample_1_10X_F8_SCReport/sce.rds")
...
removed <- sum(sce_list$sce.unfiltered$discard)

kable(tibble("QC metric" =c("Library Size", "Expressed genes", "Mitochondrial genes", "Ribosomal genes", "Total removed", "Cells remaining"),
             "Number of cells"= c(num.qc.lib, num.qc.nexprs, num.qc.mito, num.qc.ribo, removed, ncol(sce_list$sce))),
      row.names=FALSE,
...
pheatmap(log10(tab+10), color=viridis::viridis(100), silent=TRUE)
```
