...
kable(tibble("QC metric" =c("Library Size", "Expressed genes", "Mitochondrial genes", "Total removed", "Cells remaining"),
             "Number of cells"= c(num.qc.lib, num.qc.nexprs, num.qc.mito, removed, ncol(sce_list$sce))),
      row.names=FALSE,
...
cells_prop = as.data.frame(cellsProportion(sce), row.names=NULL)
ezInteractiveTableRmd(cells_prop, title="Cell proportions", digits = 3)
```
