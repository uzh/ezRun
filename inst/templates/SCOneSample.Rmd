...
FeaturePlot(object = scData, features = "detected", reduction = "tsne")
FeaturePlot(object = scData, features = "sum", reduction = "tsne")
FeaturePlot(object = scData, features = "subsets_Mito_percent", reduction = "tsne")
...
The iSEE shiny app can be accessed through this link [iSEE explorer](`r paste0("http://fgcz-shiny.uzh.ch/fgcz_iSEE/?data=",output$getColumn("Report"),"/sce_iSEE.rds")`)
