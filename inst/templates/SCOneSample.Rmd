...
sce$logDetected = log10(sce$detected)
  ...
  plotReducedDim(sce, dimred="UMAP", colour_by="logSum", text_by="seurat_clusters", text_size=5)
  ...
  plotReducedDim(sce, dimred="UMAP", colour_by="subsets_Mito_percent", text_by="seurat_clusters", 
                 text_size=5)
  plotColData(sce, x="ident", y="subsets_Ribo_percent", colour_by="ident", add_legend=FALSE) + 
    ggtitle("Ribo percentage vs ident")
  plotReducedDim(sce, dimred="UMAP", colour_by="subsets_Ribo_percent", text_by="seurat_clusters", 
                 text_size=5)
...
```{r heatmap, fig.width=12, fig.height=length(levels(sce$seurat_clusters))*0.6}
...
plotHeatmap(sce, features=genesToPlot, center=TRUE, zlim=c(-2, 2),
