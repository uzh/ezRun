...
plotColData(sce, x="Batch", y="nCount_RNA", colour_by="discard") + scale_y_log10() + ggtitle("Number of UMIs")
plotColData(sce, x="Batch", y="nFeature_RNA", colour_by="discard") + scale_y_log10() + ggtitle("Detected genes")
plotColData(sce, x="Batch", y="percent_mito", colour_by="discard") + ggtitle("Mito percent")
plotColData(sce, x="Batch", y="percent_ribo", colour_by="discard") + ggtitle("Ribo percent")
```
