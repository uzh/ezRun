...
# require(tidyverse)
# model = readRDS("/srv/gstore/projects/p2220/SCTrajectoryInference_55343_2021-03-11--10-58-03/Differentiated_lung_cells_SCTrajectoryInference/model.rds")
# dyno_dataset = readRDS("/srv/gstore/projects/p2220/SCTrajectoryInference_55343_2021-03-11--10-58-03/Differentiated_lung_cells_SCTrajectoryInference/dyno_dataset.rds")
# sce = loadHDF5SummarizedExperiment("/srv/gstore/projects/p2220/SCOneSample_50562_2021-03-10--17-22-04/Differentiated_lung_cells_SCReport/sce_h5")
# 
# param = list(start_id="0", end_id='none', start_n="1", end_id="1", TI_method='none', diff_Branch='none', diff_Branch_Point='none', root_expression='TP63,ITGA6,KRT5,KRT6A,COL17A1', show_genes='MUC1,SPDEF')
...
for(i in 1:nrow(model)) {
  ...
  plot_dimred(current_model, grouping = sce$seurat_clusters, color_density = "grouping", label_milestones = TRUE) + ggtitle("Cell grouping"),
...
```{r, eval=param$show_genes != 'none', results='asis'}
...
for(i in 1:nrow(model)) {
  ...
  current_model = model[i,]$model[[1]]
  tryCatch({
 plots= map(genes, function(feature_oi) {
  plot_dimred(current_model, expression_source = expression, feature_oi = feature_oi, label_milestones = FALSE) +
