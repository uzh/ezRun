...
mergedAbPlotGroupClass <- plot_bar(physeqMerged, "Group", "Abundance", fill="Class") + geom_bar(aes(color=Phylum, fill=Class), stat="identity", position="stack")
...
### create plots: 4. tree
plotTreeMerged <- plot_tree(physeqMergedPruned , ladderize="left", color="Group", shape="Technology", size = "abundance", label.tips="Genus")
forRadialTree <- subset_taxa(physeqMergedPruned, Phylum=="Bacteroidetes")
plotTreeRadialMerged <- plot_tree(forRadialTree,  color="Group", shape="Family", ladderize="left") + coord_polar(theta="y") + ggtitle("Bacteroidetes-only tree")
