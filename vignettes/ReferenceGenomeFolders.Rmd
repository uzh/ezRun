...
To have the necessary external tools (STAR, samtools, picard, ...) available to R,
load them from the module system before starting R:

```bash
module load Aligner/STAR/2.7.11b Tools/samtools/1.20   # plus whatever the build needs
