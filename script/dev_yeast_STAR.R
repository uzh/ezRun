...
for (i in 1:nrow(input$meta)){
    ezRunApp(ezAppSTAR, input=input[i, ], output=output[i, ], param=param)
}
...
i = 1
# for (i in 1:nrow(input$meta)){
ezRunApp(ezAppCountOverlaps, input=input[i, ], output=output[i, ], param=param)
# }
